...
data "azurerm_key_vault" "key_vault" {
  ...
  name                = try(coalesce(var.key_vault.name, local.key_vault_from_data), null)
  resource_group_name = try(coalesce(var.key_vault.resource_group_name, local.key_vault_resource_group_from_data), null)
}
