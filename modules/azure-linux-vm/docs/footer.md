...
- [with_nic](https://github.com/prefapp/tfm/tree/main/modules/azure-linux-vm/_examples/with_nic) - Example using Azure Key Vault for admin password and custom network interface configuration.
