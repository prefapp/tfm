...
module "linux_vm" {
  ...
  custom_data = file("${path.module}/cloud_init.tpl")

  # Example: Inline custom_data with multiple SSH keys using EOF
  # custom_data = <<EOF
  # #cloud-config
  # ssh_authorized_keys:
  #   - ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABgQDbzUPoxqaOUqeZZwA...
  #   - ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIC3...
