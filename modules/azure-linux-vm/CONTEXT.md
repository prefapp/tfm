...
Owns one Linux virtual machine and its network interface.
...
**nic**:
The `nic` object — subnet, optional public IP and optional network security group association. The NIC is looked up by name against existing network resources; this module does not create the network.
