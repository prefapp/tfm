...
data "azurerm_subnet" "subnet" {
  count                = var.private_endpoint != null && var.subnet_name != null && var.subnet_name != "" ? 1 : 0
...
data "azurerm_private_dns_zone" "dns_private_zone" {
  count               = var.private_endpoint != null && var.dns_private_zone_name != null && var.dns_private_zone_name != "" ? 1 : 0
