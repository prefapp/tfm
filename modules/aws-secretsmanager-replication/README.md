...
| <a name="input_destination_secret_arns"></a> [destination\_secret\_arns](#input\_destination\_secret\_arns) | Optional list of destination Secrets Manager ARNs or ARN prefixes to restrict write permissions for the Lambda. Use concrete ARNs or prefixes in production; default allows all. | `list(string)` | <pre>[<br/>  "*"<br/>]</pre> | no |
...
| <a name="input_kms_key_arns"></a> [kms\_key\_arns](#input\_kms\_key\_arns) | Optional list of KMS key ARNs used by source/destination secrets to restrict KMS permissions for the Lambda. Use concrete key ARNs in production; default allows all. | `list(string)` | <pre>[<br/>  "*"<br/>]</pre> | no |
...
| <a name="input_source_secret_arns"></a> [source\_secret\_arns](#input\_source\_secret\_arns) | Optional list of source Secrets Manager ARNs or ARN prefixes to restrict read permissions for the Lambda. Use concrete ARNs or prefixes in production; default allows all. | `list(string)` | <pre>[<br/>  "*"<br/>]</pre> | no |
