...
| <a name="input_karpenter_namespace_name"></a> [karpenter\_namespace\_name](#input\_karpenter\_namespace\_name) | Set the name of K8s namespace where is deployed the karpenter controller | `string` | `"kube-system"` | no |
| <a name="input_karpenter_service_account_name"></a> [karpenter\_service\_account\_name](#input\_karpenter\_service\_account\_name) | Set the name of K8s service account karpenter controller | `string` | `"karpenter"` | no |
