...
module "eks_prefapp" {
  ...
  alb_ingress_enabled                  = local.values.alb_ingress_enabled

  cloudwatch_enabled                   = local.values.cloudwatch_enabled

  efs_driver_enabled                   = local.values.efs_driver_enabled

  external_dns_enabled                 = local.values.external_dns_enabled

  parameter_store_enabled              = local.values.parameter_store_enabled
  ...
  cluster_tags                         = local.values.cluster_tags
