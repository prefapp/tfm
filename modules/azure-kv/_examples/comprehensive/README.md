...
These samples are documentation-oriented: replace names, IDs, and resource group with values valid in your tenant before apply. Keep large samples here instead of embedding them in the terraform-docs `README.md` body.
