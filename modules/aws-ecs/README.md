...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | ID of the VPC where resources will be created. If not set, the module will look up the VPC using vpc\_tag\_key and vpc\_tag\_name. | `any` | n/a | no |
