...
- [Vault with plan, selection, and replication](https://github.com/prefapp/tfm/tree/main/modules/aws-backup/_examples/with_alias_replication_account) – KMS key creation with alias, cross-region replication, and additional account access
