...
resource "azurerm_network_security_rule" "this" {
  ...
  resource_group_name          = each.azurerm_network_security_group.this.resource_group_name
  network_security_group_name  = each.azurerm_network_security_group.this.name
