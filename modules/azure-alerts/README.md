...
|------|-------------|------|---------|:--------:|
| <a name="input_action_group"></a> [action\_group](#input\_action\_group) | Action Group configuration(s). Accepts a list (preferred), a map (legacy), or a single object. | `any` | `[]` | no |
| <a name="input_backup_alert"></a> [backup\_alert](#input\_backup\_alert) | Backup alert processing rule configuration(s). Accepts a list (preferred), a map (legacy), or a single object. | `any` | `[]` | no |
| <a name="input_budget"></a> [budget](#input\_budget) | Budget alert configuration(s). Accepts a list (preferred), a map (legacy), or a single object. | `any` | `[]` | no |
...
| <a name="input_quota_alert"></a> [quota\_alert](#input\_quota\_alert) | Quota alert configuration(s). Accepts a list (preferred), a map (legacy), or a single object. | `any` | `[]` | no |
