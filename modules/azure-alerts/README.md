...
|------|-------------|------|---------|:--------:|
| <a name="input_action_group"></a> [action\_group](#input\_action\_group) | Action Group configuration(s). Accepts a list of objects (preferred) or a legacy map of objects. | `any` | `[]` | no |
| <a name="input_backup_alert"></a> [backup\_alert](#input\_backup\_alert) | Backup alert processing rule configuration(s). Accepts a list of objects (preferred) or a legacy map of objects. | `any` | `[]` | no |
| <a name="input_budget"></a> [budget](#input\_budget) | Budget alert configuration(s). Accepts a list of objects (preferred) or a legacy map of objects. | `any` | `[]` | no |
...
| <a name="input_identity"></a> [identity](#input\_identity) | Identity for Quota Alert | <pre>object({<br/>    name                 = string<br/>    scope                = optional(string)<br/>    role_definition_name = optional(string, "Reader")<br/>  })</pre> | `null` | no |
...
| <a name="input_quota_alert"></a> [quota\_alert](#input\_quota\_alert) | Quota alert configuration(s). Accepts a list of objects (preferred) or a legacy map of objects. | `any` | `[]` | no |
...
| <a name="output_action_group_ids"></a> [action\_group\_ids](#output\_action\_group\_ids) | Map of configured action\_group names to their resource IDs. |
...
| <a name="output_action_group_names"></a> [action\_group\_names](#output\_action\_group\_names) | Map of configured action\_group names to their names. |
...
| <a name="output_backup_alert_id"></a> [backup\_alert\_id](#output\_backup\_alert\_id) | The ID of the alert processing rule when exactly one backup\_alert is configured; otherwise null. |
| <a name="output_backup_alert_ids"></a> [backup\_alert\_ids](#output\_backup\_alert\_ids) | Map of configured backup\_alert names to their resource IDs. |
...
| <a name="output_budget_alert_ids"></a> [budget\_alert\_ids](#output\_budget\_alert\_ids) | Map of configured budget names to their resource IDs. |
...
| <a name="output_quota_alert_ids"></a> [quota\_alert\_ids](#output\_quota\_alert\_ids) | Map of configured quota\_alert names to their resource IDs. |
