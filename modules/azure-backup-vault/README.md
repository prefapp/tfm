...
| <a name="input_disk_instances"></a> [disk\_instances](#input\_disk\_instances) | List of backup instances for disks | <pre>list(object({<br/>    name                = string<br/>    location            = string<br/>    disk_resource_group = string<br/>    snapshot_resource_group_name = string<br/>   policy_key          = string<br/>  }))</pre> | `[]` | no |
