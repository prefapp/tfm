...
| [azurerm_role_assignment.snapshot_rg_contributor_backup_rg](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
...
| <a name="input_disk_instances"></a> [disk\_instances](#input\_disk\_instances) | List of backup instances for disks | <pre>list(object({<br/>    name                         = string<br/>    location                     = string<br/>    disk_resource_group          = string<br/>    policy_key                   = string<br/>    snapshot_resource_group_name = string<br/>  }))</pre> | `[]` | no |
